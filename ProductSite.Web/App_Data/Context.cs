...
{
    public partial class ProductsDB : IQuerySurface
    {
        ...
        public ProductsDB() 
        { 
            DataProvider = ProviderFactory.GetProvider("ProductsDB");
            Init();
        }

        public ProductsDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public ProductsDB(string connectionString, string providerName)
        {
