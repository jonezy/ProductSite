...
<div class="row">
    ...
    <h4>NEW ARRIVALS</h4>
    <p class="half-bottom"  style="height:34px;"><%= Model.NewArrival.BrandName.ToLower() %> - <%= Model.NewArrival.ModelName.ToLower()%></p>
    ...
    <h4>HOT DEALS</h4>
    <p class="half-bottom"  style="height:34px;"><%= Model.HotDeal.BrandName.ToLower() %> - <%= Model.HotDeal.ModelName.ToLower() %></p>
    ...
    <p class="half-bottom" style="height:34px;"><%= Model.FeaturedWatch.BrandName.ToLower()%> - <%= Model.FeaturedWatch.ModelName.ToLower()%></p>
